...
import data.lists.AllItems;
import data.lists.AllNatures;
import data.lists.AllPokemon;
    ...
    private static Pokemon[] teamBuilder(int teamNumber) {
        ...
        do {
            ...
            do {
                ...
                switch (option) {
                    case 0:
                        list = AllPokemon.allPokemon;
                        break;

                    case 1:
                        list = AllPokemon.gen1Pokemon;
                        break;

                    case 2:
                        list = AllPokemon.gen2Pokemon;
                        break;

                    case 3:
                        list = AllPokemon.gen3Pokemon;
                        break;

                    case 4:
                        list = AllPokemon.gen4Pokemon;
                        break;

                    case 5:
                        list = AllPokemon.gen5Pokemon;
                        break;

                    case 6:
                        list = AllPokemon.gen6Pokemon;
                        break;

                    case 7:
                        list = AllPokemon.gen7Pokemon;
                        break;

                    case 8:
                        list = AllPokemon.gen8Pokemon;
                        break;

                    case 9:
                        list = AllPokemon.gen9Pokemon;
                        break;

                    case 10:
                        list = AllPokemon.fakemon;
                        break;
            ...
            for (int i = 1; i <= list.size(); i++) {
                System.out.println(i + "- " + list.get(i-1).getTrueName(false, false));
            }
        ...
        do {
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    for (Pokemon form : pokemon.getForms()) {
                        if (form.formIsOutOfBattle() &&
                    ...
                    if (pokemon.getForms().length == 0) {
                        ...
                        ArrayList<Pokemon> forms = new ArrayList<>();
                        for (Pokemon form : pokemon.getForms()) {
                            if (form.formIsOutOfBattle()) {
                                count++;
